...
#define N_WORD_PHONEMES  3000 // max phonemes in a word
#define N_WORD_BYTES     160 // max bytes for the UTF8 characters in a word
#define N_PHONEME_BYTES  160 // max bytes for a phoneme
#define N_CLAUSE_WORDS   4500 // max words in a clause
#define N_TR_SOURCE      12000 // the source text of a single clause (UTF8 bytes)
